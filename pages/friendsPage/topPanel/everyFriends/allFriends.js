...
function Friends() {
  ...
  useEffect( () => {
    const getToken = async () =>{
      ...
      axios
        .get( `${URL}/api/v1/user/friend/findAll`,
        {
          headers: {
  ...
  return( 
    ...
    <View style={styles.body}>
      <View style={styles.leftText}>
        <Text style={styles.bodyText}>친구 <Text style={styles.bodyCountText}>{myfriends.length}</Text>명</Text>
